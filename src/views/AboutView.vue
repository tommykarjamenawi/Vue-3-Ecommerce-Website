    ...
    >
      ...
      <div class="px-8 py-6">
        <p>
          ...
          <span class="text-green-400 px-1">aboutMe</span>
        ...
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;name:
          <span class="text-yellow-300">'Tommy Karjamenawi'</span>,
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;student nr:
          <span class="text-yellow-300">'652192'</span>,
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;class:
          <span class="text-yellow-300">IT2A</span>,
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;school:
          <span class="text-yellow-300">'Inholland'</span>,
        </p>
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;website:
          <span class="text-yellow-300"
            >'<a
              href="https://tktesting.online"
              target="_blank"
              class="text-yellow-300 hover:underline focus:border-none"
              >https://tktesting.online</a
            >'</span
          >,
        </p>
        <p>&nbsp;&nbsp;}</p>
